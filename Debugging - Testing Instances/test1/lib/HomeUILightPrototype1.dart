...
class HomeUILightPrototype1 extends StatelessWidget {
  HomeUILightPrototype1({
    Key key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            Pin(size: 163.0, start: 30.0),
            Pin(size: 163.0, start: -17.0),
            child:
...
const String _svg_px3oew =
    '<svg viewBox="742.0 796.0 607.0 1.0" ><path transform="translate(742.0, 796.0)" d="M 0 0 L 607 0" fill="none" stroke="#cbcbcb" stroke-width="7" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
