...
#ifndef TEST3_SWIFT_H
#define TEST3_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="test3",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC5test311AppDelegate")
...
SWIFT_CLASS("_TtC5test317MainFlutterWindow")
